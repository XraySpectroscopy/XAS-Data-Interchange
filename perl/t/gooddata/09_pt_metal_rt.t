...
## test the pt_metal_rt good data example
...
ok( (($labels[0] eq 'energy') and
     ...
     ($labels[2] eq 'itrans')),                                  'labels: label names');
...
my @values = (11434.00, 1.00, 293113.1, 47988.70);
...
@values = (11434.00, 1.00, 293113.1, 47988.70) ;
