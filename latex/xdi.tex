...
\begin{center}
  ...
  \normalsize
  Bruce Ravel (NIST) \href{mailto:bravel@bnl.gov}{\texttt{bravel\char64 bnl.gov}}\\
  ...and...
\end{center}
...
\item Provide a mechanism for extracting and preserving a single
  ...
  database or a hierarchical data file used to store a multi-spectral
  data set).
\end{enumerate}
...
Any measurements of times present \textbf{must} be represented as
...
\begin{HeaderField}{Collimation}{<text>}{fixed-angle, Rh-coated toroid}
...
The inter-planer spacing of the monochromator's crystals, in {\AA}ngstroms.
\begin{verbatim}
...
\begin{HeaderField}{Edge\_energy}{<float>}{5465}
  ...
  energy of the absorbing atom -- as defined in the data acquisition
...
\begin{HeaderField}{End\_time}{<timestamp>}{2003-04-01T13:01:02}
  ...
  specified in ISO 8601\footnote{ISO 8601, \textit{
      Representation of dates and times} is explained succinctly at\\
...
\begin{HeaderField}{Focusing}{<text>}{saggitally bent second crystal}
